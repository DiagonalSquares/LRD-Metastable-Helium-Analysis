...
Furthermore, within our results for the ratios between the metastable He I $10830\AA$ line and $Pa\gamma$ line, we see that even when dust extinction is no longer a factor affecting the ratios, our flux ratios are still pushing the boundaries of what Pyneb is able to predict. The primordial helium-to-hydrogen abundance is ~0.08 \citep{Hsyu_2020}. The abundance ratio used in this study was set as 0.01, which is a much more conservative value. Even with this conservative estimate though, we see that our LRDs fall near the bottom of our density lines, nearly falling below Pyneb's predicted ratios. These results, combined with the results of the dust corrected $\frac{F_{5876\AA}}{{F_{7065\AA}}}$ ratios allow us to reasonably conclude that dust correction ultimately plays a minimal role in explaining why these ratios seem to go beyond what Pyneb can produce.
